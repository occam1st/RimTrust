...
namespace RimTrust.Trade.Ext
{
    public class Trader_BankNoteExchange : VirtualTrader
    {
        ...
        public override string TipString(int index)
        {
            ...
            {
                case 1:
                    //return "DepositTitle".Translate();
                    //simple TrustFunds value debug show on console title
                    return "TrustFunds: " + Methods.TrustFunds.ToString() + " BankNotes (" + (Methods.TrustFunds *1000).ToString("N0") + " silver)";

                case 2:
                    return "DepositTip".Translate();

                case 3:
                    return "DepositSilverTip".Translate();

                case 4:
                    return "DepositBankNoteTip".Translate();
